...
public class Profile {
    ...
    public Profile(String fcmUserDeviceId,
                   String username,
                   long timestamp,
                   String name,
                   String firstname,
    ...
    public Profile(String name, String photoUrl, String uid) {
        this.name = name;
        this.photoUrl = photoUrl;
        this.uid = uid;
    }
    ...
    // cards
    public Profile(String uid, String name, String firstname, String lastname, String photoUrl, String birthdate, String isMale) {
        this.uid = uid;
        this.name = name;
        this.firstname = firstname;
        this.lastname = lastname;
    ...
    // cards with birthday
    public Profile(String uid, String name, String photoUrl, String isMale, String birthdate) {
        this.uid = uid;
        this.name = name;
        this.photoUrl = photoUrl;
        this.isMale = Boolean.parseBoolean(isMale);
    ...
    // Facebook user
    public Profile(String photoUrl,
                   String photoThumb,
                   String uid,
                   String username,
                   String name,
