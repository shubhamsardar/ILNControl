...
import kotlinx.android.synthetic.main.activity_corrected_profiles.*
import java.text.SimpleDateFormat

class CorrectedProfilesActivity : AppCompatActivity() {

    lateinit var context : Context
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_corrected_profiles)
        context = this
        setAdapter()
    }
    ...
    private fun setAdapter() {
        ...
        corrected_list.layoutManager = LinearLayoutManager(this) as RecyclerView.LayoutManager?
        corrected_list.adapter = adapter
    }
